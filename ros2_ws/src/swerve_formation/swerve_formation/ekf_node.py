...
class EKFNode(Node):
    ...
    `/{robot_id}/initialpose` (PoseWithCovarianceStamped) hard-resets the
    state and covariance. The GUI's "Set Initial Pose" tool fans this out
    so the operator can hint RTAB-Map's relocalization scan.
    """
